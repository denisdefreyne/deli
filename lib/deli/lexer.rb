  ...
  class MainLexerMode < AbstractLexerMode
    def lex_token(mode_stack)
      ...
      # Two-character tokens
        ...
        new_token(TokenType::EQ_EQ, scanner.matched)
      elsif scanner.scan('!=')
        new_token(TokenType::BANG_EQ, scanner.matched)
      elsif scanner.scan('<=')
        new_token(TokenType::LTE, scanner.matched)
      elsif scanner.scan('>=')
        new_token(TokenType::GTE, scanner.matched)

      # One-character tokens
      elsif scanner.scan('+')
        new_token(TokenType::PLUS, scanner.matched)
      elsif scanner.scan('-')
        new_token(TokenType::MINUS, scanner.matched)
      elsif scanner.scan('*')
        new_token(TokenType::ASTERISK, scanner.matched)
      elsif scanner.scan('/')
        new_token(TokenType::SLASH, scanner.matched)
      elsif scanner.scan('<')
        new_token(TokenType::LT, scanner.matched)
      elsif scanner.scan('>')
        new_token(TokenType::GT, scanner.matched)
      elsif scanner.scan(',')
        ...
        new_token(TokenType::EQ, scanner.matched)
      elsif scanner.scan('!')
        new_token(TokenType::BANG, scanner.matched)
      elsif scanner.scan('(')
